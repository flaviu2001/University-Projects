...
public interface PurchaseService {
    /**
     * Saves the purchase with the given attributes to the core.repository of purchases
     *
    ...
    /**
     * @return all purchases from the core.repository
     */
     ...
     */
    List<Pair<Long, Integer>> getPurchasesSortedSpentCashInterface();
