...
public class FoodDatabaseRepository {
    @Autowired
    ...
    public Iterable<Food> findAllEntities() {
    ...
    public Optional<Food> saveEntity(Food entity) throws ValidatorException {
    ...
    public Optional<Food> deleteEntity(Long aLong) {
