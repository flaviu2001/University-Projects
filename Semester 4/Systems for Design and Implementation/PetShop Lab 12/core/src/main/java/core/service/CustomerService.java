...
public interface CustomerService {
    /**
     * Saves the customer with the given attributes to the core.repository of customers
     *
     * @throws IllegalArgumentException if the given id is null.
     * @throws ValidatorException       if the cat entity is not valid.
     */
    void addCustomer(String name, String phoneNumber, PetHouse petHouse);

    /**
     * @return all customers from the core.repository
     */
    List<Customer> getCustomersFromRepository();

    List<Purchase> findPurchasesOfCustomerByCustomerId(long customerId);
     ...
     * @throws PetShopException         if the customer does not exist
     */
    void updateCustomer(Long id, String name, String phoneNumber, PetHouse petHouse);
}
