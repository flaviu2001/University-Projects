...
public class PurchaseController {
    ...
    PurchasesDTO getPurchasesOfCat (@PathVariable Long id) {
        return new PurchasesDTO(purchaseConverter.convertModelsToDTOs(catService.findPurchasesOfCatByCatId(id)));
    }

    @RequestMapping(value = "/purchases-of-customer/{id}")
    PurchasesDTO getPurchasesOfCustomer(@PathVariable Long id) {
        return new PurchasesDTO(purchaseConverter.convertModelsToDTOs(customerService.findPurchasesOfCustomerByCustomerId(id)));
    }
